...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['comment'])) {
    ...
    $insert_comment_sql = $conn->prepare("INSERT INTO comments_1 (comment, created_at) VALUES (?, NOW())");
...
<div class="categories-container">
  ...
  <div class="button-container">
    ...
    <a href="seo.php"><button class="filter-button active" data-category="S_E_O">S.E.O</button></a>
    <a href="branding.php"><button class="filter-button" data-category="BRANDING">BRANDING</button></a>
  </div>

  <div class="introduction">
    <h1>Welcome to Search Engine Optimization</h1>
    <h4>Optimize Your Online Presence, Amplify Your Success: Transforming Visibility into Valuable Traffic with Cutting-Edge SEO Strategies</h4>
  </div>
  <div class="contents">
    <h2>Contents</h2>
  </div>
  ...
  <div class="cards-container" id="cards-container">
    <?php
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        <div class="card">
          <div class="image-box">
            <img src="image/SEO.png" alt="Article Image">
          </div>
  ...
  <div class="comments-container">
    ...
    <div id="comments-section">
      <?php
          ...
          $comments_sql = $conn->prepare("SELECT comment, created_at FROM comments_1 ORDER BY created_at DESC");
